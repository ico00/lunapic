...
const base = "h-4 w-4 shrink-0" as const;

type IconProps = SVGProps<SVGSVGElement>;

export function SectionIconTime(props: IconProps) {
  return (
    <svg
      viewBox="0 0 24 24"
      fill="none"
    ...
    >
      <path
        ...
        d="M12 6v6h4.5m6.75 0a9.75 9.75 0 11-19.5 0 9.75 9.75 0 0119.5 0z"
      />
    </svg>
  );
}
...
export function SectionIconObserver(props: IconProps) {
  return (
    <svg
      viewBox="0 0 24 24"
      fill="none"
...
export function SectionIconMoon(props: IconProps) {
  return (
    <svg
      viewBox="0 0 24 24"
      fill="none"
...
export function SectionIconCamera(props: IconProps) {
  return (
    <svg
      viewBox="0 0 24 24"
      fill="none"
...
export function SectionIconField(props: IconProps) {
  return (
    <svg
      viewBox="0 0 24 24"
      fill="none"
...
export function SectionIconFlightLog(props: IconProps) {
  return (
    <svg viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth={1.5} className={base} aria-hidden {...props}>
