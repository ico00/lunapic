          ...
          <div className="flex flex-col gap-3 px-3 pb-4 pt-1 sm:flex-row sm:items-end sm:justify-between sm:gap-4">
            ...
            <div className="w-full shrink-0 sm:max-w-sm">
              ...
              <input
                ...
                autoComplete="off"
                spellCheck={false}
                className="w-full rounded-md border border-zinc-700 bg-zinc-900/90 px-3 py-2 text-[16px] text-zinc-100 shadow-inner shadow-black/20 outline-none ring-blue-500/30 placeholder:text-zinc-500 focus:border-blue-500/40 focus:ring-2"
              />
              {isSearchActive ? (
