...
const faqs = [
  ...
  },
  {
    ...
    answer:
      "The bar is a quick **height scale** (MSL): map symbols run from **light green** (low) through **green** into **blue** and **dark blue** at high cruise, by reported **baro/geo altitude**. Tick labels under the bar are **short kilometre marks** (`0m`, `2k`, `4.5k` … = 0 m, 2 km, 4.5 km, and so on). **Bright green** (`#22c55e`) still marks **shot-feasible** aircraft — same meaning as elsewhere on the map (camera tools), even if that hue appears in the low-altitude part of the scale. **Color by altitude** turns the height scale off so other traffic uses one neutral tone; shot-feasible flights stay green. The **3D aircraft marker** also scales a bit with altitude (same height values).",
  },
  {
