...
| **[flight-sources.md](./flight-sources.md)**                             | **Live flight feeds:** OpenSky OAuth2 + credits, adsb.lol, Raspberry Pi push, poll cadence, circuit breakers, failure playbook |
